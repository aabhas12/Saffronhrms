...
public class Leave extends Activity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ivLogout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(Leave.this,
						MainActivity.class));
				Leave.this.finish();
			}
		});
				...
				.setSingleChoiceItems(employeename, 0,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								for (int i = 0; i < Leave.this.employeename
										.size(); i++) {
									if (Leave.this.employeename
											.get(i).toString()
				...
				.setSingleChoiceItems(visitType, 0,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								for (int i = 0; i < Leave.this.visitType
										.size(); i++) {
									if (Leave.this.visitType
											.get(i).toString()
		...
		// items are selected
				.setSingleChoiceItems(visitType, 0,
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
									int which) {
								for (int i = 0; i < Leave.this.customer
										.size(); i++) {
									if (Leave.this.customer
											.get(i).toString()
											.equals(visitType[which])) {
										tempCustomerID = customerID.get(i);
									}
	...
	private void setTime(final TextView etPickupTime2) {
		...
		mTimePicker = new TimePickerDialog(Leave.this,
	...
	private class FetchVisitType extends AsyncTask<Void, Void, SoapObject> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			progress = new ProgressDialog(Leave.this);
